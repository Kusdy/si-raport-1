                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <?php if (!in_array($item['id_siswa'], $processedSiswa)): ?>
                            <tr>
                                ...
                                <?php endforeach ?>
                                <td>
                                    <a type="button" href="<?= base_url('kepsek/kelola_raport/view/' . $item['id_siswa']) ?>" class="btn rounded-pill btn-primary btn-sm"><i class="bx bx-book-bookmark"></i> Raport</a>
                                    <a type="button" href="<?= base_url('kepsek/kelola_raport/cetak_raport/' . $item['id_siswa']) ?>" class="btn rounded-pill btn-danger btn-sm"><i class="bx bx-printer"></i> Cetak</a>
                                </td>
                            </tr>
