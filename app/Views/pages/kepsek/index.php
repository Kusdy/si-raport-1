					...
					<div class="col-lg-3 col-md-12 col-6 mb-4">
						<div class="card shadow-lg">
							<div class="card-body">
								...
								<h3 class="card-title text-nowrap mb-1"><?= count($siswa) ?> Data</h3>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-12 col-6 mb-4">
							...
							<div class="card-body">
								<div class="card-title d-flex align-items-start justify-content-between">
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
											<a class="dropdown-item" href="<?= base_url('kepsek/kelola_raport') ?>">Lihat</a>
										</div>
									</div>
								</div>
								<h3 class="card-title text-nowrap mb-1"><?= count($raport) ?> Data</h3>
							</div>
						</div>
					</div>
				</div>
