            ...
            <div class="col-md-12">
                        ...
                        <form id="filterForm">
                            <div class="row gx-3 gy-2 align-items-center">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select placement-dropdown" id="roleDropdown" name="role"
                                        required>
                ...
                <div class="card">
                    <div style="position: relative;">
                        <a type="button" href="<?= base_url('admin/data-pengguna/new') ?>" class="btn btn-primary"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="<?= base_url('admin/data-pengguna/edit/' . $item['id_user']) ?>"><i
                                                        class="bx bx-edit-alt me-2"></i> Edit</a>
                                                <a type="button" class="dropdown-item" data-bs-toggle="modal"
                                                    data-bs-target="#hapus-<?= $item['id_user'] ?>"
                                                    data-delete-url="<?= base_url('admin/data-pengguna/delete/' . $item['id_user']) ?>"><i
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/data-pengguna/delete/' . $item['id_user']) ?>">
                <div class="modal-body">
                    <p>Yakin ingin menghapus data pengguna atas nama <b><?= $item['nama']; ?></b>? klik hapus jika Ya!
                    </p>
                </div>
