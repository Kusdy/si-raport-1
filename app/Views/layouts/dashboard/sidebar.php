<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            class="menu-item <?= ($active == 'siswa' || $active == 'guru' || $active == 'walikelas') ? 'active open' : '' ?>">
        ...
        <!-- Forms -->
        <!-- Tables -->
        <li class="menu-item <?= ($active == 'set kelas') ? 'active' : '' ?>">
            <a href="<?= base_url('admin/kelola_set_kelas') ?>" class="menu-link">
