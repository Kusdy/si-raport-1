<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?= ($active == 'dashboard') ? 'active' : '' ?>">
            <a href="<?= base_url('wakel/dashboard') ?>" class="menu-link">
        ...
        <li class="menu-item <?= ($active == 'nilai') ? 'active' : '' ?>">
            <a href="<?= base_url('wakel/nilai') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-graduation"></i>
                <div data-i18n="Basic">Input Nilai</div>
            </a>
        </li>
        <li class="menu-item <?= ($active == 'raport') ? 'active' : '' ?>">
            <a href="<?= base_url('wakel/raport') ?>" class="menu-link">
